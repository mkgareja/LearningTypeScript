...
//     // We can do anything here, like updating the descriptor or completely overriding the function
//     descriptor.value = (...params:any[]) => {
//       console.log("We changed the original function!");
//       console.log(
//         "But Wait, there's more, we still have access to the original!"
//       );
...
//     doAction() {
//       // Do your thing here
//       console.log("doAction has been called with: ", ...arguments);
//     }
//   }
  
//   const myClassInstance = new MyClass();
//   myClassInstance.doAction(); //pass in variables to see them on the other side
...
// Accessor Decorators
//As with Method decorators, it allows us to modify the descriptor (which includes the getters and setters)


//https://codepen.io/johan-dutoit/pen/ExjQZNz?editors=1112
...
// simply add the decorator before the property. If you're not going to use an external library, then I'd pass on using a property decorator and instead use an accessor or method decorator.
...
//   ) {
//     // Useful if you use external libraries like `reflect-metadata`
//     console.log('hey');
...
//   const myClassInstance = new MyClass();
//   myClassInstance.doAction("Some value", 3);
...
//(1)  Collage, collage location,collage type and add few att add print all information with help intersection 
//(2)  Write function which uses type guard typeof,in,instanceof
//(3)  Function Overloading with multiplication 
//(4)  Example for generic with class
...
// function getArray<mahesh>(items : mahesh[] ) : mahesh[] {
//     return new Array<mahesh>().concat(items);
// }
...
//   const bStorage = new DataStorage<boolean>();
//   bStorage.addItem(true);
//   bStorage.addItem(false);
//   bStorage.removeItem(false);
